<template><div><h1 id="postgresql解压版初始化" tabindex="-1"><a class="header-anchor" href="#postgresql解压版初始化" aria-hidden="true">#</a> Postgresql解压版初始化</h1>
<h2 id="初始化数据库" tabindex="-1"><a class="header-anchor" href="#初始化数据库" aria-hidden="true">#</a> 初始化数据库</h2>
