import{_ as n,o as s,c as a,d as e}from"./app-e6ebb439.js";const i={},l=e(`<h1 id="云南用途管制启动-整合版" tabindex="-1"><a class="header-anchor" href="#云南用途管制启动-整合版" aria-hidden="true">#</a> 云南用途管制启动（整合版）</h1><h2 id="_1-启动中间件" tabindex="-1"><a class="header-anchor" href="#_1-启动中间件" aria-hidden="true">#</a> 1 启动中间件</h2><h3 id="_1-1-启动zookeeper" tabindex="-1"><a class="header-anchor" href="#_1-1-启动zookeeper" aria-hidden="true">#</a> 1.1 启动Zookeeper</h3><blockquote><p>进入<code>9.77.251.98</code>服务器，通过SSH连接服务器</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 进入命令目录</span>
