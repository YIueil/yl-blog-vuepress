import{_ as a,o as n,c as s,a as e}from"./app-0853d01b.js";const t={},l=e(`<h1 id="centos7下安装mysql8" tabindex="-1"><a class="header-anchor" href="#centos7下安装mysql8" aria-hidden="true">#</a> CentOS7下安装MySQL8</h1><h2 id="_1-下载mysql包" tabindex="-1"><a class="header-anchor" href="#_1-下载mysql包" aria-hidden="true">#</a> 1 下载mysql包</h2><p>选择最新版本的mysql8的压缩包进行下载: https://dev.mysql.com/downloads/mysql/</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">## 进入应用安装目录</span>
