import{_ as n,o as a,c as s,a as e}from"./app-f4076533.js";const i={},t=e(`<h1 id="centos7安装nginx" tabindex="-1"><a class="header-anchor" href="#centos7安装nginx" aria-hidden="true">#</a> CentOS7安装Nginx</h1><h2 id="使用root用户安装前置依赖" tabindex="-1"><a class="header-anchor" href="#使用root用户安装前置依赖" aria-hidden="true">#</a> 使用root用户安装前置依赖</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token parameter variable">-y</span> <span class="token function">install</span> gcc <span class="token function">wget</span> gcc-c++ automake autoconf libtool libxml2-devel libxslt-devel perl-devel perl-ExtUtils-Embed pcre-devel openssl-devel
