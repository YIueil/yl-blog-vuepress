import{_ as a,o as n,c as s,a as e}from"./app-eae545e9.js";const l={},i=e(`<h1 id="ollama常用命令" tabindex="-1"><a class="header-anchor" href="#ollama常用命令" aria-hidden="true">#</a> Ollama常用命令</h1><h2 id="_1-模型下载" tabindex="-1"><a class="header-anchor" href="#_1-模型下载" aria-hidden="true">#</a> 1 模型下载</h2><h3 id="列举模型" tabindex="-1"><a class="header-anchor" href="#列举模型" aria-hidden="true">#</a> 列举模型</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 命令</span>
