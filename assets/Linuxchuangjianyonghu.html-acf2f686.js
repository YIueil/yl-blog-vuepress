import{_ as n,o as a,c as s,d as e}from"./app-61943fb0.js";const i={},l=e(`<h1 id="linux创建用户" tabindex="-1"><a class="header-anchor" href="#linux创建用户" aria-hidden="true">#</a> Linux创建用户</h1><h2 id="_1-快速创建命令" tabindex="-1"><a class="header-anchor" href="#_1-快速创建命令" aria-hidden="true">#</a> 1 快速创建命令</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 使用adduser命令（交互式，推荐）</span>
