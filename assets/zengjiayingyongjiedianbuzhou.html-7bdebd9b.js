import{_ as n,o as s,c as a,a as e}from"./app-f4076533.js";const i={},p=e(`<h1 id="增加应用节点步骤" tabindex="-1"><a class="header-anchor" href="#增加应用节点步骤" aria-hidden="true">#</a> 增加应用节点步骤</h1><h2 id="增加应用节点步骤-1" tabindex="-1"><a class="header-anchor" href="#增加应用节点步骤-1" aria-hidden="true">#</a> 增加应用节点步骤</h2><h3 id="_1-创建用户" tabindex="-1"><a class="header-anchor" href="#_1-创建用户" aria-hidden="true">#</a> 1 创建用户</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 修改主机名称</span>
