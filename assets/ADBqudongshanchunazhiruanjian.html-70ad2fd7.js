import{_ as n,o as a,c as e,d as s}from"./app-e07ee649.js";const i={},d=s(`<h1 id="通过adb驱动删除内置软件-md" tabindex="-1"><a class="header-anchor" href="#通过adb驱动删除内置软件-md" aria-hidden="true">#</a> 通过adb驱动删除内置软件.md</h1><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 进入adb shell</span>
adb shell
