import{_ as s,o as n,c as a,a as e}from"./app-eae545e9.js";const c={},i=e(`<h1 id="centos7监控cpu、内存占用" tabindex="-1"><a class="header-anchor" href="#centos7监控cpu、内存占用" aria-hidden="true">#</a> CentOS7监控CPU、内存占用</h1><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 安装 sysstat</span>
