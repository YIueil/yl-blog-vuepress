import{_ as n,o as s,c as a,d as e}from"./app-857e0191.js";const t={},i=e(`<h1 id="postgresql编写实例" tabindex="-1"><a class="header-anchor" href="#postgresql编写实例" aria-hidden="true">#</a> PostgreSQL编写实例</h1><h2 id="_1-递归查询" tabindex="-1"><a class="header-anchor" href="#_1-递归查询" aria-hidden="true">#</a> 1 递归查询</h2><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">WITH</span> RECURSIVE SubDirectories <span class="token keyword">AS</span> <span class="token punctuation">(</span>
