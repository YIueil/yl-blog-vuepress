import{_ as n,o as s,c as a,d as e}from"./app-61943fb0.js";const i={},l=e(`<h1 id="增加应用节点步骤" tabindex="-1"><a class="header-anchor" href="#增加应用节点步骤" aria-hidden="true">#</a> 增加应用节点步骤</h1><h2 id="增加应用节点步骤-1" tabindex="-1"><a class="header-anchor" href="#增加应用节点步骤-1" aria-hidden="true">#</a> 增加应用节点步骤</h2><h3 id="_1-创建用户" tabindex="-1"><a class="header-anchor" href="#_1-创建用户" aria-hidden="true">#</a> 1 创建用户</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 修改主机名称</span>
...
<span class="token function">chown</span> <span class="token parameter variable">-R</span> app /opt/app/ytgz
<span class="token function">chown</span> <span class="token parameter variable">-R</span> app /opt/file
...
./startup.sh
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12),p=[l];function c(r,d){return s(),a("div",null,p)}const o=n(i,[["render",c],["__file","zengjiayingyongjiedianbuzhou.html.vue"]]);export{o as default};
