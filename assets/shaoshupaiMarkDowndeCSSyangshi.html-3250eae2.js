import{_ as n,o as s,c as a,a as p}from"./app-f4076533.js";const t={},e=p(`<h1 id="少数派markdown的css样式" tabindex="-1"><a class="header-anchor" href="#少数派markdown的css样式" aria-hidden="true">#</a> 少数派MarkDown的CSS样式</h1><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">body</span> <span class="token punctuation">{</span>
